...
DEPLOY_ENV=prod
DEPLOY_HOST=tredf-antonioelsonmoreira.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for tredf-antonioelsonmoreira.tangrama.com.br, enable SSH, and install a supported version of Python 3 on that system.
...
cluster:
  hosts:
    tredf-antonioelsonmoreira.tangrama.com.br:
      ansible_user: root
      ansible_host: tredf-antonioelsonmoreira.tangrama.com.br
      host: tredf-antonioelsonmoreira
      hostname: tredf-antonioelsonmoreira.tangrama.com.br
      swarm_node:
        labels:
          type: manager
          env: production
...
Deploy the stack defined in `devops/stacks/tredf-antonioelsonmoreira.tangrama.com.br.yml` to the remote server with:
